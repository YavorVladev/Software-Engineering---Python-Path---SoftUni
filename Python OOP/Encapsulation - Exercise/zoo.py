...
class Zoo:
    ...
    def animals_status(self):
        lions = list(filter(lambda a: a.__clas__.__name__ == "Lion", self.animals))
        tigers = list(filter(lambda a: a.__clas__.__name__ == "Tiger", self.animals))
        cheetahs = list(filter(lambda a: a.__clas__.__name__ == "Cheetah", self.animals))
    ...
    def workers_status(self):
        ...
        [info[x._class__.__name__].append(str(x)) for x in self.workers]
