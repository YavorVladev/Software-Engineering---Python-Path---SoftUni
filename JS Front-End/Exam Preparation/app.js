...
function solve() {
  ...
  const otherDOMSelectors = {
    publishedBtn: document.getElementById('form-btn'),
  ...
  function publishStoryHandler(event) {
    ...
    otherDOMSelectors.publishedBtn.setAttribute('disabled', true)
  ...
  function deleteStoryHandler(event) {
    ...
    liItem.remove();
    otherDOMSelectors.publishedBtn.removeAttribute("disabled");
